...
var Ut = (i, t) => {
  ...
  for (let a = 0; a < e; a++) {
    ...
    for (; g < h.length && (n.lastIndex = g, u = n.exec(h), u !== null); )
      g = n.lastIndex, n === w ? u[1] === "!--" ? n = et : u[1] !== void 0 ? n = st : u[2] !== void 0 ? (lt.test(u[2]) && (r = RegExp("</" + u[2], "g")), n = y) : u[3] !== void 0 && (n = y) : n === y ? u[0] === ">" ? (n = r ?? w, c = -1) : u[1] === void 0 ? c = -2 : (c = n.lastIndex - u[2].length, d = u[1], n = u[3] === void 0 ? y : u[3] === '"' ? rt : it) : n === rt || n === it ? n = y : n === et || n === st ? n = w : (n = y, r = void 0);
      ...
      if (r.nodeType === 1) {
        ...
        if (lt.test(r.tagName)) {
          ...
          if (g > 0) {
            ...
            for (let f = 0; f < g; f++)
              r.append(c[f], M()), S.nextNode(), h.push({ type: 2, index: ++o });
            r.append(c[g], M());
          }
        }
...
var I = class _I {
  ...
  k(t) {
    ...
    let s, r = 0;
    for (const o of t)
      r === e.length ? e.push(s = new _I(this.O(M()), this.O(M()), this, this.options)) : s = e[r], s._$AI(o), r++;
...
var z = class {
  ...
  _$AI(t, e = this, s, r) {
    ...
    let n = false;
    if (o === void 0)
      t = C(this, t, e, 0), n = !N(t) || t !== this._$AH && t !== b, n && (this._$AH = t);
    else {
      const a = t;
      let h, d;
      for (t = o[0], h = 0; h < o.length - 1; h++)
        d = C(this, a[s + h], e, h), d === b && (d = this._$AH[h]), n || (n = !N(d) || d !== this._$AH[h]), d === l ? t = l : t !== l && (t += (d ?? "") + o[h + 1]), this._$AH[h] = d;
    }
    n && !r && this.j(t);
  }
  j(t) {
...
var T = (i, t) => {
  ...
  if (e === void 0)
    return false;
  for (const r of e)
    (s = r._$AO) == null || s.call(r, t, false), T(r, t);
  return true;
};
var D = (i) => {
  let t, e;
...
@giscus/react/dist/giscus-Ci9LqPcC.js:
   ...
   *)
*/
//# sourceMappingURL=giscus-Ci9LqPcC-TG2MD42B.js.map
