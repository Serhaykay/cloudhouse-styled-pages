  ...
  return (
    <>
      <motion.nav
        ...
        className={`fixed top-4 left-4 right-4 z-50 mx-auto transition-all duration-300 max-w-7xl ${
          scrolled
            ? 'bg-white/90 backdrop-blur-md shadow-lg rounded-2xl text-[#1E293B]'
            : 'bg-transparent text-white'
        }`}
      >
        <div className="flex justify-between items-center px-4 py-3 md:py-4 transition-all duration-300">
          <Link to="/">
